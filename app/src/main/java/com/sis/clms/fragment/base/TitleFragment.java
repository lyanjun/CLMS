...
import com.sis.clms.utils.DensityUtils;
        ...
        switch (mLayoutWay) {
            case TitleLayout.LINEAR_LAYOUT://创建线性布局
                ...
                LinearLayout.LayoutParams tParamsL = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                        DensityUtils.dp2px(mContext, LinearLayout.LayoutParams.WRAP_CONTENT));
                titleView.setMinimumHeight(TitleLayout.ACTION_BAR_SIZE);
